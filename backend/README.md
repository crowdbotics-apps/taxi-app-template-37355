...
## Project Structure
    ...
    ├── taxi_app_template_37355  # Django project configurations
...
1. Clone this repo and `cd taxi_app_template_37355`
...
2. Clone this repo and `cd taxi_app_template_37355`
